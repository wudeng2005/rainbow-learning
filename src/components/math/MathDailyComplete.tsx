...
export default function MathDailyComplete({
  ...
  return (
    <div className="min-h-dvh flex flex-col items-center justify-center bg-gradient-to-b from-pink-100 via-rose-50 to-emerald-50 px-6">
      <motion.div
      ...
      >
        ...
        <div className="flex flex-col gap-3 w-full max-w-[240px] mx-auto">
          <motion.button
            type="button"
            className="px-8 py-4 rounded-full bg-gradient-to-r from-pink-400 to-emerald-400 text-white font-bold text-lg shadow-lg"
            whileTap={{ scale: 0.95 }}
            onClick={onPlayAgain}
          >
            🍭 再来一次
