...
UpdateProgress --> CheckComplete{"会话完成?"}
...
**图表来源**
- [src/store/useLearningStore.ts:50-68](file://src/store/useLearningStore.ts#L50-L68)
- [src/store/useLearningStore.ts:142-154](file://src/store/useLearningStore.ts#L142-L154)
...
- [src/lib/db/syncManager.ts:64-70](file://src/lib/db/syncManager.ts#L64-L70)
...
**图表来源**
- [src/store/useErrorBankStore.ts:58-76](file://src/store/useErrorBankStore.ts#L58-L76)
...
该数据持久化方案为类似教育类应用提供了优秀的参考模板，特别是在混合存储策略和智能同步机制方面具有重要的借鉴价值。